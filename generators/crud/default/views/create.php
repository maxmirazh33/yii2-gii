...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-create">
    ...
    <p class="clear">
        <?= "<?= Html::a('{$generator->generateString('All')} " . mb_strtolower($generator->getLocalName(Generator::LOCAL_INDEX)) . "', ['index'], ['class' => 'btn btn-flat btn-info btn-right glyphicon-list']) ?>\n" ?>
    </p>
